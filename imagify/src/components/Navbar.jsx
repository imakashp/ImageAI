        ...
        <div>
            {
                ...
                <div className='flex items-center gap-2 sm:gap-3'>
                    <button onClick={()=>navigate('/buy')} className='flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 rounded-full hover:scale-105 transition-all duration-700'>
                        ...
                        <p className='text-xs sm:text-sm font-medium text-gray-600'>Credits left : {user.credit}</p>
                    </button>
                ...
                <div className='flex items-center gap-2 sm:gap-5'>
                    ...
                    <button onClick={()=>setShowLogin(true)} className='bg-zinc-800 text-white w-19 px-7 py-2 sm:px-2 text-sm rounded-full'>Login</button>
                </div>
                )
            }
        </div>
